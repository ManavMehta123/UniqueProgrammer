	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Unique Programmer</h1>
			</div>
         	...
         	<div class="row">
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find Quizzes related to programming 
         				</p>
         			</div>
         		</div>
<!-- 
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center" style="position: relative;left:105%;">
									<h4 class="team-member-name">Manav Mehta</h4>
									<h4 class="team-member-designation">Student</h4>
